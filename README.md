...
|---------------------------|------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------|
| MONGODB_URI_DEV           | Used for connecting to development database                                                                                  | mongodb+srv:://[username:password@]host1[:port1][,...hostN[:portN]][/[defaultauthdb][?options]]                                              |
| MONGODB_URI_LIVE          | Used for connecting to production database                                                                                   | mongodb+srv:://[username:password@]host1[:port1][,...hostN[:portN]][/[defaultauthdb][?options]]                                              |
| PORT                      | Port used to run application on                                                                                              | 3000                                                                                                                                         |
| API_URL                   | Computer Vision API - Deep Stack server URL                                                                                  | http://192.168.1.8:5000                                                                                                                      |
| DETECTION_MIN_CONFIDENCE  | Minimum confidence to recognise objects [0-1]                                                                                | 0.50                                                                                                                                         |
| FAMILY_PHONE_IP_ADDRESSES | List of local ip addresses of phones. Used to detect if device is home. Separate addresses with a space.                     | 192.168.1.10 192.168.1.11                                                                                                                    |
| HOUSE_OVERRIDE_TIME_START | Time at which start to override house occupied status                                                                        | 22                                                                                                                                           |
| HOUSE_OVERRIDE_TIME_END   | Time at which stop to override house occupied status                                                                         | 6                                                                                                                                            |
| DROPBOX_API_KEY           | API key to access Dropbox                                                                                                    | xxx-xxx-xxx                                                                                                                                  |
| IFTTT_WEBHOOKS            | List of IFTTT webhooks to send notifications to (includes image hosted on Dropbox). Separate multiple addresses with a space | https://maker.ifttt.com/trigger/xxx/with/key/xxx                                                                                             |
| SLACK_BOT_TOKEN           | Token to use Slack box                                                                                                       | xxx-xxx-xxx                                                                                                                                  |
| REDIS_HOST                | IP address of Redis server if not running locally                                                                            | 192.168.1.10                                                                                                                                 |
| CAMERA_LEARNING_URL       | URL to download image to save. Reolink NVR                                                                                   | http://(ip address)/cgi-bin/api.cgi?cmd=Snap&channel=0&rs=(any combination of numbers and letters)&user=(user name)&password=(user password) |
